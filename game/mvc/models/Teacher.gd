...
func rm_teacher_by_id(id : int) -> void:
	var query = "DELETE FROM Teachers WHERE id=?"
	if !Utils.db.execute(query, [id]):
		print("Erreur de suppression.")
		return

func rm_teachers_by_dept(dept: String, nb: int) -> void:
...
func get_if_fulltime(id : int) -> bool:
...
func set_fulltime(id : int, fulltime: bool) -> void:
