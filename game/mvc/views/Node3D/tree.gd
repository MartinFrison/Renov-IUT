...
const trunc_path: String = "res://mvc/views/Node3D/trunc.tres"
const material_path: String = "res://mvc/views/Node3D/leaf.tres"
const texture_path: String = "res://mvc/views/Node3D/Leaf1.png"
const mask_path: String = "res://mvc/views/Node3D/Leaf1.png"
...
func _ready() -> void:
	...
	var shader = load("res://mvc/views/Node3D/alpha.gdshader") as Shader  # Remplacez par le chemin vers votre shader
